...
El circuito esquematico completo del minilab se encuentra en el anexo~\ref{anexo:circuito} al final del informe.
...
entre la alimentación desde una fuente de continua externta o una batería de 9V interna. La tensión seleccionada
...
Por fuera de esto, durante el armado del MiniLab no encotramos dificultades significativas. Las tareas fueron distribuidas entre los
integrantes del grupo, lo que permitió avanzar de manera fluida en el proceso de construcción. A la hora de integrar 
el trabajo de cada integrante no hubo inconvenentes ya que se mantuvo un buen nivel de comunicación y coordinación entre todos.
