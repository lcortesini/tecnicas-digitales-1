...
Este bloque consta de 6 salidas digitales, cada una capaz de proporcionar un tanto un nivel lógico alto como bajo.
Estas salidas se utilizan para simular diferentes combinaciones de entrada para circuitos lógicos que se deseen probar.
Para seleccionar el estado de cada salida, se utiliza una llave de selección.
Ademas, cada salida cuenta con un LED indicador que muestra el estado actual de la salida, facilitando la visualización de las combinaciones lógicas.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{image/salida.png}
    \caption{Salida digital}
    \label{fig:salida}
\end{figure}
