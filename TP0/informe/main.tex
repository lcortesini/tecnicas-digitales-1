...
En la figura~\ref{fig:implementacion} se muestra una imagen del circuito implementado en el MiniLab.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{image/implementacion.jpeg}
...
\includepdf[pages=-, landscape=true]{../sch/output.pdf}\label{anexo:circuito}
