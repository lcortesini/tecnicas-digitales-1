...
Simular el modulo de ejemplo (`mux4`):
...
Generar el esquematico RTL, con bloques de alto nivel (`build/rtl_view/mux4.svg`):
...
Genera `build/rtl_view/mux4_gates_schematic.svg`.
...
2. Crea `tb/mi_modulo_tb.v` con el testbench correspondiente
   (copia y adapta `tb/mux4_tb.v` como referencia, prestando
